...
import './AccountAddressResponsivePage.scss';
...
const AccountAddressResponsivePage: React.FC = () => {
	...
	return !user ? (
		...
		<Page className={'rsAccountAddressResponsivePage'}>
...
export default AccountAddressResponsivePage;
