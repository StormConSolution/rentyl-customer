...
import './AccountPaymentMethodsResponsivePage.scss';
...
const AccountPaymentMethodsResponsivePage: React.FC = () => {
	...
	return !user ? (
		...
		<Page className={'rsAccountPaymentMethodsResponsivePage'}>
...
export default AccountPaymentMethodsResponsivePage;
